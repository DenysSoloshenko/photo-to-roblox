class OrderReadyNotifier
  def self.call(order, stage:)
    ...
    body = stage == :preview ? "Review the free interactive preview and unlock the editable map for $19 if you love it." : "Your payment is confirmed and the editable Roblox map is ready."
